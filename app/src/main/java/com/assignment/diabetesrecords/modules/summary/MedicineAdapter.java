...
public class MedicineAdapter extends
    ...
    public  class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            delete = itemView.findViewById(R.id.Delete_Medicine);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                deleteMedicine(record.getId(), record.getEntryDate(), record.getEntryTime(), record.getFoodTakenStatus(),record.getTitle(),record.getDescription(),record.getInsulineInformation());
