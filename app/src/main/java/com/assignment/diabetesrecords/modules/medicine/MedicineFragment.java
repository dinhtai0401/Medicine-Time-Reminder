...
public class MedicineFragment extends DialogFragment implements TimePickerDialog.OnTimeSetListener,
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        TextView textView = parent.findViewById(R.id.id_data);
        dateet = (EditText) parent.findViewById(R.id.dateet);
        timeet = (EditText) parent.findViewById(R.id.timeet);
        spReadingTimings = parent.findViewById(R.id.spReadingTimings);
        ...
        bAddAnother = parent.findViewById(R.id.bAddAnother);
    ...
    private void update()
    {
        ...
        try{
            ...
            l = medicineManager.update(medicineRecord);
