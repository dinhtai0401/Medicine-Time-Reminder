...
public class CustomCalendarView extends LinearLayout {
    ...
    public CustomCalendarView(final Context context, @Nullable AttributeSet attrs) {
        ...
        gridView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                EventRecylerAdapter eventRecylerAdapter = new EventRecylerAdapter(showView.getContext(), CollectEventByDate(date));
    ...
    private ArrayList<Events> CollectEventByDate(String date){
        ...
        helper = new DBHelper(context);
        SQLiteDatabase database = helper.getReadableDatabase();
        Cursor cursor = helper.ReadEvents(date, database);
        while (cursor.moveToNext()){
    ...
    private void SaveEvent(String event, String time, String date, String month, String year,String notify) {
        ...
        helper.SaveEvent(event, time, date, month, year, notify, database);
        helper.close();
    ...
    private void CollectEventPerMonth(String Month, String year){
        ...
        helper = new DBHelper(context);
        SQLiteDatabase database = helper.getReadableDatabase();
        Cursor cursor = helper.ReadEventsperMonth(Month, year, database);
        while (cursor.moveToNext()){
            String event = cursor.getString(cursor.getColumnIndex(DBStructure.EVENT));
            String time = cursor.getString(cursor.getColumnIndex(DBStructure.TIME));
            String date = cursor.getString(cursor.getColumnIndex(DBStructure.DATE));
